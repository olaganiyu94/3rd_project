             ...
             <div class="col-lg-9">  <!-- Jumbotron Header -->
                ...
                <div class="row text-center">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card">
                            <img class="card-img-top" src="images/robert.png" alt="">
                            <div class="card-body">
                                <h4 class="card-title">Robert Plant Tickets</h4>
                                <p class="card-text">Robert Plant was part of one of the most successful bands in rock history - Led Zeppelin. They band split after 12 years and Plant launched his solo career in 1982 with the album Pictures at Eleven. 
                                </p>
                            </div>
                     ...
                     <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card">
                            <img class="card-img-top" src="images/bruno.png" alt="">
                            <div class="card-body">
                                <h4 class="card-title">Bruno Mars Tickets</h4>
                                <p class="card-text">Please note All prices listed exclude fees & charges
                                Under 16s must be accompanied by a parent or guardian 25+ over 
                                </p>
                            </div>
                            <div class="card-footer">
                                <input type="number" name="mquantity" v-model="mquantity">
